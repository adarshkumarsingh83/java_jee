...
/**
 * @Product : PreparedStatementTest provide implementation of the specification
 *                    provided for the ...    
 */
 ...
 * @version $Revision: 1.0 $, $Date:: 4/6/13 2:28 PM
 * @see
 */
...
public class PreparedStatementTest {
    ...
    public void saveEmployee() throws Exception {
        Employee employee=new Employee(4,"sonu","sonu@singh");
    ...
    public void updateEmployee()throws Exception{
        Employee employee=new Employee(4,"Sonu Singh","sonu@singh.com");
        final boolean result= employeeRepository.updateEmployee(employee);
        LOGGER.info("Employee Updated "+result);
    }

    @Test
    public void deleteEmployee()throws Exception{
        final boolean result=employeeRepository.deleteEmployee(4);

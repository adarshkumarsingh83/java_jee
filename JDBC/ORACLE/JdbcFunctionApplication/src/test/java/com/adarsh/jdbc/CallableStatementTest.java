...
public class CallableStatementTest {
    ...
    public void selectOne() throws Exception {
        final Employee employee = employeeRepository.getEmployee(6);
        LOGGER.info(employee.toString());
    }

    @Test
    public void selectAllEmployee() throws Exception {
        final List<Employee> employeeList = employeeRepository.getAllEmployee();
    ...
    public void saveEmployee() throws Exception {
        Employee employee = new Employee(4, "SONU KUMAR ", "AMIT@KUMAR.COM");
    ...
    public void updateEmployee() throws Exception {
        Employee employee = new Employee(4, "Sonu kumar Singh", "sonu@singh.com");
    ...
    public void deleteEmployee() throws Exception {
        final String result = employeeRepository.deleteEmployee(2);

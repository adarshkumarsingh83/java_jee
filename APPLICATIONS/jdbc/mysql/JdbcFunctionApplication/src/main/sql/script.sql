...
DELIMITER ;
-- ------------------------------------------------------------------------------------------------------------------------------------------------
-- SET @selectEmpData = selectEmpFunction(1);
...
DELIMITER ;
-- ------------------------------------------------------------------------------------------------------------------------------------------------
-- SET @insertEmpCount = insertEmpFunction(3,'sonu','sonu@singh.com');
...
DELIMITER ;
-- ------------------------------------------------------------------------------------------------------------------------------------------------
-- SET @updateEmpCount = updateEmpFunction(3,'Sonu Singh','sonu@singh.com');
...
DELIMITER ;
-- ------------------------------------------------------------------------------------------------------------------------------------------------
-- SET @deletedEmpCount = deleteEmpFunction(3);

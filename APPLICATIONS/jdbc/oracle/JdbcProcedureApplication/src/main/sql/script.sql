...
/
--------------------------------------------------------------------------------------------------------------------------------------------------
/* TO RUN THE GET ALL EMP PROCEDURE*/
SET SERVEROUTPUT ON;
 DECLARE
   V_EMP_DATA_CURSOR SYS_REFCURSOR;
   V_EMPNO EMPLOYEE.EMPNO%TYPE;
...
BEGIN
  OPEN EMP_ALL_DATA_CURSOR FOR
   ...
   SELECT EMP.EMPNO,EMP.EMPNAME,EMP.EMPEMAIL FROM EMPLOYEE EMP ORDER BY EMPNO;
...
/
--------------------------------------------------------------------------------------------------------------------------------------------------
/* TO RUN THE INSERT EMP PROCEDURE*/
SET SERVEROUTPUT ON;
DECLARE
   DATA VARCHAR(50) ;
BEGIN
...
/
--------------------------------------------------------------------------------------------------------------------------------------------------
/* TO RUN THE UPDATE EMP PROCEDURE*/
SET SERVEROUTPUT ON;
DECLARE
   DATA VARCHAR(50) ;
BEGIN
...
/
--------------------------------------------------------------------------------------------------------------------------------------------------
/* TO RUN THE DELETE EMP PROCEDURE*/
SET SERVEROUTPUT ON;
DECLARE

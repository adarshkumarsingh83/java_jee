...
--------------------------------------------------------------------------------------------------------------------------------------------------
/* INSERT BLOCK FOR EMPLOYEE TABLE */
 ...
 /
--------------------------------------------------------------------------------------------------------------------------------------------------
/* EXECUTION BLOCK FOR GET EMP FUNCTION  */
 SET SERVEROUTPUT ON;
 DECLARE
...
/
--------------------------------------------------------------------------------------------------------------------------------------------------
/* EXECUTION BLOCK FOR GET ALL EMP FUNCTION  */
 SET SERVEROUTPUT ON;
 DECLARE
       ...
       SELECT COUNT(*) INTO V_COUNT FROM EMPLOYEE ;
		   IF V_COUNT != 0 THEN
				OPEN V_EMP_ALL_DATA_CURSOR
					FOR SELECT EMP.EMPNO,EMP.EMPNAME,EMP.EMPEMAIL FROM EMPLOYEE EMP ORDER BY EMP.EMPNO;
		   ELSE
					V_SELECT_ERROR_MSG :='NO EMPLOYEE FOUND';
		   END IF;
...
/
--------------------------------------------------------------------------------------------------------------------------------------------------
/* EXECUTION BLOCK FOR INSERT EMP FUNCTION  */
SET SERVEROUTPUT ON;
DECLARE
   DATA VARCHAR(50) ;
BEGIN
...
/
--------------------------------------------------------------------------------------------------------------------------------------------------
/* EXECUTION BLOCK FOR UPDATE EMP FUNCTION  */
SET SERVEROUTPUT ON;
DECLARE
   DATA VARCHAR(50) ;
BEGIN
...
/
--------------------------------------------------------------------------------------------------------------------------------------------------
/* EXECUTION BLOCK FOR DELETE EMP FUNCTION  */
SET SERVEROUTPUT ON;
DECLARE
   DATA VARCHAR(50) ;
BEGIN
